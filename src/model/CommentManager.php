...
{	
	...
	{
		 $db = $this->dbConnect();
        $req = $db->prepare('SELECT id, pseudo, content, DATE_FORMAT(date_comment, \'%d/%m/%Y à %Hh%imin\') AS dateComment_fr FROM comments WHERE id_post = ? ORDER BY date_comment DESC');
